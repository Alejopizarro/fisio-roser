  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-6 w-full">
        <div className="flex flex-col justify-around p-8 space-y-4 bg-[url(/blobs-purple.svg)] rounded-lg shadow-lg sm:basis-2/3">
      ...
      <div className="flex flex-col sm:flex-row-reverse gap-6 w-full">
        <div className="flex flex-col justify-around space-y-4 p-8 bg-[url(/blobs.svg)] rounded-lg shadow-lg sm:basis-2/3">
